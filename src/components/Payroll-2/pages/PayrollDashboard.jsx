...
//---------------------------------------
// src/pages/PayrollDashboard.jsx College Account
// import React, { useState, useEffect } from 'react';
// import { employees as initialEmployees, payrollMetrics as initialMetrics, 
//         bonusesData as initialBonuses, payrollTrends as initialTrends } from '../data/mockData';
// import { saveToLocalStorage, loadFromLocalStorage, exportToCSV, generatePayslip, 
...
//   // Update metrics when employees or filters change
//   useEffect(() => {
//     const newMetrics = calculateMetrics(filteredEmployees, selectedMonth);
//     setMetrics(newMetrics);
//     saveToLocalStorage('payrollMetrics', newMetrics);
//   }, [filteredEmployees, selectedMonth]);

//   const calculateMetrics = (empList, monthFilter) => {
...
//         return empDate.getMonth() === month && 
//                empDate.getFullYear() === year;
//       });
//     }
...
//           ...emp, 
//           ...employeeData,
//           // Preserve existing date and status
//           date: emp.date,
//           status: emp.status
//         } : emp
//       );
...
//               </button>
//             </div>
//             <BarChart data={selectedMonth === 'all' ? initialTrends : trends} />
//           </section>
