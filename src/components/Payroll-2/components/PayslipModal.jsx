...
const PayslipModal = ({ payslip, onClose }) => {
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr class="total">
                    ...
                    <td>${formatIndianCurrency(payslip.grossSalary + (payslip.reimbursement || 0))}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>${formatIndianCurrency(payslip.esic)}</td>
                  </tr>
                  <tr class="total">
  ...
  const handleDownload = () => {
    const payslipData = [{
      ...
      'Gross Earnings': payslip.grossSalary + (payslip.reimbursement || 0),
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between font-semibold border-t pt-2 mt-2">
                  <span>Gross Earnings</span>
                  {/* <span>{formatIndianCurrency(payslip.grossSalary + (payslip.reimbursement || 0))}</span> */}
