...
//     // Save all positions to a separate positions array
//     const allPositions = newDepartment.positions.map(pos => ({
//       ...pos,
//       department: newDepartment.name,
//       id: `pos-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`
//     }));
//     setPositions(prev => [...prev, ...allPositions]);
//     saveEmployees([...positions, ...allPositions], 'positions');
