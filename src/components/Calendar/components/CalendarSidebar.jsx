...
const CalendarSidebar = ({ currentDate, selectedDate, onDateClick, events, setShowEventForm, setShowHolidaysView }) => {
  const [currentMonth, setCurrentMonth] = useState(new Date());
    ...
    <div className="w-64 bg-white border-r p-4 flex flex-col">
      ...
      <div className="p-5 mt-4">
        <button 
          ...
          className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded transition flex items-center justify-center"
        >
